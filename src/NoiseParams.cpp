...
void NoiseParams::setDepthNoise(double std) { Qdepth_ << 1e9,0,0, 0,1e9,0, 0,0,std*std; }
...
void NoiseParams::setDvlNoise(double std) { Qdvl_ = std*std*Eigen::Matrix3d::Identity(); }
